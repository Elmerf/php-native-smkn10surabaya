            ...
            <div class="card-body table-active">
                <form class="form-singin font-weight-bold text-info" method="POST" action="crudmateri.php" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="namafile" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                        <label>Materi</label>
                    ...
                    <?php echo "<input name='id' value='$_GET[id]' hidden />" ?>
                    <?php echo "<input name='hal' value='edit' hidden />" ?>
                    <button type="submit" name="btn_simpanmateri" class="btn btn-outline-info bg-info text-white font-weight-bold rounded-pill">SIMPAN</button>
