        ...
        <div class="container col-md-4 justify-content-center">
            <div class="card shadow rounded-lg" data-aos="zoom-in-left" data-aos-duration="1000">
                <div class="card-header font-weight-bold bg-info text-white text-center">
                    <h2 class="font1">Tambah Data Pengguna</h2>
                </div>
                <div class="card-body table-active">
                    <form class="form-singin font-weight-bold text-info" method="POST" action="crud.php">
                        ...
                        <button type="submit" name="btn_simpan" class="btn btn-outline-info bg-info text-white font-weight-bold rounded-pill">SIMPAN</button>
